...
const minify = true;
const hash = true;
const shellFile = "C:/sources/workspace-console/my-starter-project/target/vaadin-flow-bundle.html";
const fragmentFiles = [];
const es6SourceDirectory = "C:/sources/workspace-console/my-starter-project/target/frontend";
const targetDirectory = "C:/sources/workspace-console/my-starter-project/target/my-starter-project-1.0-SNAPSHOT";
